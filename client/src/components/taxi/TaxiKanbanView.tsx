      ...
      <div className="flex gap-4 overflow-x-auto pb-6">
        {assignedColumns.map(colId => {
          ...
          return (
            <div
              key={colId}
              className={`flex-shrink-0 w-96 bg-white dark:bg-gray-900 rounded-lg border-2 flex flex-col ${
                isDropping ? 'border-blue-500 dark:border-blue-600 ring-2 ring-blue-200' : 'border-gray-200 dark:border-gray-800'
              }`}
            >
              {/* Column header */}
              <div className={`px-4 py-3 border-b font-semibold ${
                isUnassigned ? 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300' : 'bg-blue-50 dark:bg-blue-950/40 text-blue-900 dark:text-blue-400'
              }`}>
              ...
              {/* Column content */}
              <div
                className={`flex-1 p-3 space-y-2 overflow-y-auto min-h-96 ${isDropping ? 'bg-blue-50 dark:bg-blue-950/40' : ''}`}
                ...
                {columnTrips.length === 0 ? (
                  ...
                  columnTrips.map(trip => {
                    ...
                    return (
                      ...
                      >
                        {/* Card actions (hover) */}
                        <div className="absolute top-2 right-2 hidden group-hover/card:flex gap-1 bg-white dark:bg-gray-900 rounded shadow-sm">
                          <button
                            onClick={() => openEdit(trip)}
                            className="p-1 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/40 rounded"
                            title="Edit"
                          >✏️</button>
                          <button
                            onClick={() => deleteTrip(trip.id)}
                            className="p-1 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 rounded"
                            title="Delete"
                          >✕</button>
                        </div>
                        ...
                        <div className="text-xs text-gray-700 dark:text-gray-300 mb-2">
                          ...
                          {guestName(trip.booking_id, bookings) && (
                            <div className="font-semibold text-gray-800 dark:text-gray-200">👤 {guestName(trip.booking_id, bookings)}</div>
                          )}
                        </div>

                        {/* Passengers & luggage */}
                        <div className="text-xs text-gray-600 dark:text-gray-400 space-y-0.5 mb-2 pb-2 border-b">
