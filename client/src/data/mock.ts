...
export const mockBookings: Booking[] = [
  { id: 'bk1', booking_number: 1, client_id: 'c1', check_in: '2026-02-05', check_out: '2026-02-12', visa_entry_date: '2026-02-04', visa_exit_date: '2026-02-13', status: 'confirmed', notes: null, num_lessons: 3, num_equipment_rentals: 2, num_center_access: 0, client: mockClients[0], arrival_time: '14:30', departure_time: '10:00', luggage_count: 2, boardbag_count: 1, taxi_arrival: true, taxi_departure: true, couples_count: 1, children_count: 0, amount_paid: 500, ...nullBookingImport },
  { id: 'bk2', booking_number: 2, client_id: 'c2', check_in: '2026-02-10', check_out: '2026-02-18', visa_entry_date: '2026-02-09', visa_exit_date: '2026-02-19', status: 'provisional', notes: null, num_lessons: 2, num_equipment_rentals: 3, num_center_access: 1, client: mockClients[1], arrival_time: '16:00', departure_time: '11:00', luggage_count: 1, boardbag_count: 2, taxi_arrival: false, taxi_departure: true, couples_count: 0, children_count: 2, amount_paid: 450, ...nullBookingImport },
