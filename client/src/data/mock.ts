import type { Accommodation, Room, Booking, BookingRoom, Client, Instructor, Lesson, PriceItem, DayActivity, TaxiDriver, TaxiTrip, Equipment, EquipmentRental, Participant } from '../types/database'
...
export const mockBookings: Booking[] = [
  { id: 'bk1', client_id: 'c1', check_in: '2026-02-05', check_out: '2026-02-12', status: 'confirmed', notes: null, num_lessons: 3, num_equipment_rentals: 2, client: mockClients[0], arrival_time: '14:30', departure_time: '10:00', luggage_count: 2, boardbag_count: 1, taxi_arrival: true, taxi_departure: true, couples_count: 1, children_count: 0, amount_paid: 500, participants: [p('p1a', 'Jean', 'Dupont', 'AB123456'), p('p1b', 'Camille', 'Dupont', 'AB123457')] },
  { id: 'bk2', client_id: 'c2', check_in: '2026-02-10', check_out: '2026-02-18', status: 'provisional', notes: null, num_lessons: 2, num_equipment_rentals: 3, client: mockClients[1], arrival_time: '16:00', departure_time: '11:00', luggage_count: 1, boardbag_count: 2, taxi_arrival: false, taxi_departure: true, couples_count: 0, children_count: 2, amount_paid: 450, participants: [p('p2a', 'Marie', 'Martin', 'BE789012')] },
  ...
  { id: 'bk5', client_id: 'c2', check_in: '2026-02-01', check_out: '2026-02-08', status: 'confirmed', notes: null, num_lessons: 2, num_equipment_rentals: 2, client: mockClients[1], arrival_time: '15:45', departure_time: '10:30', luggage_count: 2, boardbag_count: 0, taxi_arrival: true, taxi_departure: true, couples_count: 1, children_count: 0, amount_paid: 400, participants: [p('p5a', 'Marie', 'Martin', 'BE789012'), p('p5b', 'Tom', 'Martin', 'BE789013')] },
  { id: 'bk6', client_id: 'c3', check_in: '2026-03-01', check_out: '2026-03-10', status: 'provisional', notes: null, num_lessons: 1, num_equipment_rentals: 4, client: mockClients[2], arrival_time: '12:00', departure_time: '12:00', luggage_count: 1, boardbag_count: 3, taxi_arrival: false, taxi_departure: false, couples_count: 0, children_count: 0, amount_paid: 300, participants: [p('p6a', 'Pierre', 'Durand', 'DE345678')] },
]
