...
export const managementI18n = {
  ...
  // DatabaseTab
  title_active_database: { fr: 'Base de données active', en: 'Active Database', es: 'Base de datos activa' },
  msg_test_db_warning: { fr: '⚠️ Vous êtes connecté à la base de données de TEST. Tous les changements sont isolés de la production.', en: '⚠️ You are connected to the TEST database. All changes are isolated from production.', es: '⚠️ Está conectado a la base de datos de PRUEBA. Todos los cambios están aislados de producción.' },
  label_production: { fr: 'Production', en: 'Production', es: 'Producción' },
  label_test:        { fr: 'Test',       en: 'Test',        es: 'Prueba' },
  label_currently_active: { fr: 'Actuellement active', en: 'Currently active', es: 'Actualmente activa' },
  label_not_configured:   { fr: 'Non configurée',      en: 'Not configured',  es: 'No configurada' },
  title_db_overview: { fr: 'Aperçu de la base de données', en: 'Database Overview', es: 'Resumen de la base de datos' },
  link_open_supabase: { fr: 'Ouvrir le tableau de bord Supabase ↗', en: 'Open Supabase Dashboard ↗', es: 'Abrir panel de Supabase ↗' },
  msg_loading_stats: { fr: 'Chargement des statistiques…', en: 'Loading stats…', es: 'Cargando estadísticas…' },
  msg_stats_load_failed: { fr: 'Impossible de charger les statistiques :', en: 'Could not load stats:', es: 'No se pudieron cargar las estadísticas:' },
  label_total_db_size: { fr: 'Taille totale de la BD', en: 'Total DB size', es: 'Tamaño total de la BD' },
  label_tables: { fr: 'Tables', en: 'Tables', es: 'Tablas' },
  label_total_rows: { fr: 'Lignes totales', en: 'Total rows', es: 'Filas totales' },
  col_table:   { fr: 'Table',    en: 'Table',    es: 'Tabla' },
  col_rows:    { fr: 'Lignes',   en: 'Rows',     es: 'Filas' },
  col_table_size: { fr: 'Taille de la table', en: 'Table size', es: 'Tamaño de la tabla' },
  col_indexes: { fr: 'Index',    en: 'Indexes',  es: 'Índices' },
  col_total:   { fr: 'Total',    en: 'Total',    es: 'Total' },
