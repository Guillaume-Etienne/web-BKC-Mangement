...
export const pagesI18n = {
  ...
  tab_enquiries:   { fr: 'Demandes',        en: 'Enquiries',     es: 'Consultas' },
  ...
  msg_new_enquiry:           { fr: '{count} nouvelle demande à lire',   en: '{count} new enquiry to read',    es: '{count} nueva consulta para leer' },
  msg_new_enquiries:         { fr: '{count} nouvelles demandes à lire', en: '{count} new enquiries to read',  es: '{count} nuevas consultas para leer' },
  ...
  msg_silent_enquiry:        { fr: '{count} demande en attente de votre réponse depuis une semaine ou plus',   en: '{count} enquiry waiting on you for a week or more',   es: '{count} consulta esperando su respuesta desde hace una semana o más' },
  msg_silent_enquiries:      { fr: '{count} demandes en attente de votre réponse depuis une semaine ou plus',  en: '{count} enquiries waiting on you for a week or more', es: '{count} consultas esperando su respuesta desde hace una semana o más' },
  msg_crm_failed_enquiry:    { fr: '{count} demande non ajoutée à Brevo',   en: '{count} enquiry not added to Brevo',   es: '{count} consulta no añadida a Brevo' },
  msg_crm_failed_enquiries:  { fr: '{count} demandes non ajoutées à Brevo', en: '{count} enquiries not added to Brevo', es: '{count} consultas no añadidas a Brevo' },
